...
from core.langgraph_types import ParticipantSet
from core.langgraph_utils import sanitize_json, llm, summary_chain
from core.langgraph_prompts import PROMPT_PARTICIPANT_KNOWLEDGE
...
def summarize_thread_node(state):
    ...
    # Create and save thread summary
    thread = state["thread"]
